...
type Config struct {
	...
	// ParentalListID is the ID for parental rules list.
	ParentalListID int `yaml:"-"`
	// SafeBrowsingListID is the ID for safe browsing rules list.
	SafeBrowsingListID int `yaml:"-"`
	// SafeSearchListID is the ID for safe search rules list.
	SafeSearchListID int `yaml:"-"`
}
...
type DNSFilter struct {
	...
	// parentalListID is used in rules generated by parental control filter.
	parentalListID int64
	// safeBrowsingListID is used in rules generated by safe browsing filter.
	safeBrowsingListID int64
	// safeSearchListID is used in rules generated by safe searching filter.
	safeSearchListID int64
}
...
func InitModule(blockedSvcListID int) {
	initBlockedServices(blockedSvcListID)
}
...
func New(c *Config, blockFilters []Filter) (d *DNSFilter) {
	...
	if c != nil {
		d.parentalListID = int64(c.ParentalListID)
		d.safeBrowsingListID = int64(c.SafeBrowsingListID)
		d.safeSearchListID = int64(c.SafeSearchListID)
